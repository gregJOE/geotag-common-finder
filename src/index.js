...
var CLIENT_EMAIL = 'your_service_account_email';
var PRIVATE_KEY = 'your_private_key';
function accessGoogleSheet() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    rows = _a.sent();
                    return [2 /*return*/, rows.map(function (row) { return row.instagram_url; })];
            }
        });
    });
}
...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, accessGoogleSheet()];
                case 1:
                    urls = _a.sent();
                    return [2 /*return*/];
            }
